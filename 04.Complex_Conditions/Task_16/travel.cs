/* 16. Пътешествие
Трета задача от междинния изпит на 6 март 2016. Тествайте решението си тук.
...
namespace Task_16
{
    class travel
    {
        static void Main()
        {
            ...
            double weekendsinsf = 48 - weekendsathome;
            double satgames = weekendsinsf * 3 / 4;
            double holidaygamesinsf = holidays * 2 / 3;

            double gamestotal = satgames + holidaygamesinsf + weekendsathome;
