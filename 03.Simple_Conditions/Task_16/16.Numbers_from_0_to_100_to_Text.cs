/* Task #16: Изписване на число до 100 с думи
...
namespace Task_16
{
    class Program
    {
        static void Main()
        {
            ...
            //Console.WriteLine("{0}", String.Format("0:dd - MM - yyyy", birthday));
        }
    }
}
...
namespace Task_16
{
    class Program
    {
        ...
        {
            var input = Console.ReadLine();
            var birthday = DateTime.Parse(input,"dd-MM-yyyy");
            DateTime answer = birthday.AddDays(999);
...
namespace Task_16
{
    class Program
    {
        ...
        {
            var input = Console.ReadLine();
            var birthday = DateTime.Parse(input.ToString());
            DateTime answer = birthday.AddDays(999);
